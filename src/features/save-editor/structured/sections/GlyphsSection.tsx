      ...
      <div className="section-content">
        ...
        <div className={`subtab-content ${activeSubtab === 'settings' ? 'active' : ''}`}>
          ...
          <div className="resource-group">
            ...
            <FieldDescription>
              Glyph generation uses the shared Reality random streams. The seed and Gaussian values are edited
              once in Progression → Reality → General, together with the separate music stream values.
            </FieldDescription>
          </div>
        </div>
