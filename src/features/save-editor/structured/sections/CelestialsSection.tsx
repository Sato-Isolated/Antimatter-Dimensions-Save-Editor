              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    ...
                    value={(androidSaveData?.celestials?.teresa?.bestRunAM as unknown) || {mantissa: 0, exponent: 0}}
              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    ...
                    value={(androidSaveData?.celestials?.teresa?.lastRepeatedMachines as unknown) || {mantissa: 0, exponent: 0}}
            ...
            <div className="celestials-grid">
              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    label="Relic Shards"
                    value={(androidSaveData?.celestials?.effarig?.relicShards as unknown) || {mantissa: 0, exponent: 0}}
              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    ...
                    value={(androidSaveData?.celestials?.enslaved?.stored as unknown) || {mantissa: 0, exponent: 0}}
            ...
            <div className="celestials-grid">
              ...
              <div className="form-group">
                ...
                <input
                  type="number"
                  id="v-goalCompletion"
                  value={(saveData.celestials?.v as unknown as { goalCompletion?: number })?.goalCompletion || 0}
            ...
            <div className="celestials-grid">
              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    label="Dark Matter"
                    value={(androidSaveData?.celestials?.laitela?.darkMatter as unknown) || {mantissa: 0, exponent: 0}}
              ...
              <div className="form-group">
                {isPCFormat() ? (
                  ...
                  <BigNumberInput
                    label="Dark Energy"
                    value={(androidSaveData?.celestials?.laitela?.darkEnergy as unknown) || {mantissa: 0, exponent: 0}}
