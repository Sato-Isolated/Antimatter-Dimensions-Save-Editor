...
const AutoBuyersSection: React.FC<SectionProps> = ({ 
  ...
  // Cast saveData to the platform-specific view when needed.
  const pcSaveData = isPCFormat() ? saveData as PCStruct : null;
  const androidSaveData = !isPCFormat() ? saveData as AndroidStruct : null;
  const autoSaveData = saveData as unknown as { auto?: { autobuyersOn?: boolean } };
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  value={isPCFormat() ? 
                    ...
                    (autoSaveData.auto?.autobuyersOn ?? false ? 'true' : 'false')}
