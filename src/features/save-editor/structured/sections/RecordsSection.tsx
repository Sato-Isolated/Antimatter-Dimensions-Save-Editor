...
type RecordScalar = string | number;

interface RecordEntryView {
  totalAntimatter?: RecordScalar;
  ...
  time?: number;
  maxAM?: RecordScalar;
  bestIPmin?: RecordScalar;
  maxIP?: RecordScalar;
  bestEPmin?: RecordScalar;
  maxEP?: RecordScalar;
  maxReplicanti?: RecordScalar;
  maxDT?: RecordScalar;
  bestIPminEternity?: RecordScalar;
  bestIPminReality?: RecordScalar;
  bestEPminReality?: RecordScalar;
  RM?: RecordScalar;
  RMmin?: RecordScalar;
  glyphLevel?: number;
  glyphStrength?: number;
  thisInfinity?: RecordEntryView;
  thisEternity?: RecordEntryView;
  thisReality?: RecordEntryView;
  bestInfinity?: RecordEntryView;
  bestEternity?: RecordEntryView;
  bestReality?: RecordEntryView;
  [key: string]: RecordScalar | RecordEntryView | RecordEntryView[] | undefined;
}

interface RecordsView extends RecordEntryView {
  recentInfinities?: RecordEntryView[];
  recentEternities?: RecordEntryView[];
  recentRealities?: RecordEntryView[];
  lastTenInfinities?: RecordEntryView[];
  lastTenEternities?: RecordEntryView[];
  lastTenRealities?: RecordEntryView[];
}
...
const RecordsSection: React.FC<SectionProps> = ({ saveData, handleValueChange, renderValidationIndicator }) => {
  ...
  const typedSaveData = saveData as unknown as { records?: RecordsView };
