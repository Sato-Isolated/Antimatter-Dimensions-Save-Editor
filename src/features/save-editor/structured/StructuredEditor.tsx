...
import { useSave, useSaveSelector } from '../../../app/state/SaveContext';
import { tokenizeDocumentPath } from '../../../domain/save/document/path';
...
const structuredSections = structuredSectionCatalog;
    ...
    <div className="structured-editor" aria-label="Structured save editor">
      ...
      <article className="editor-document">
        ...
        >
          ...
          saveData={modifiedSaveData as unknown as AntimatterDimensionsStruct}
