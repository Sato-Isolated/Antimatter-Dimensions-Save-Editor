...
import androidFixture from '../fixtures/save/android.json';
import newsaveFixture from '../fixtures/save/newsave.json';
import pcFixture from '../fixtures/save/pc.json';
import { encodeSaveData } from '../../src/domain/save/transport/codec';
import { readFieldValue, saveEditorFields } from '../../src/domain/save/catalog/fields';
